...
from deezer_python.exceptions import (
    DeezerErrorResponse,
    DeezerHTTPError,
...
class Client:
    ...
    be passed in to the constructor as kwargs.
        ...
        >>> import deezer
        >>> client = deezer_python.Client(app_id='foo', app_secret='bar')
    ...
    For example, use ``Accept-Language`` header to force the output language.
        ...
        >>> import deezer
        >>> client = deezer_python.Client(headers={'Accept-Language': 'fr'})
    ...
    base_url = "https://api.deezer_python.com"
    ...
    def _process_json(
        ...
        to :class:`~deezer_python.Resource` object
        ...
        :returns: instance of :class:`~deezer_python.Resource`
        """
        if "data" in item:
            parsed_data = [
    ...
    def get_album(self, album_id: int) -> Album:
        ...
        :returns: an :class:`~deezer_python.Album` object
        """
    ...
    def get_artist(self, artist_id: int) -> Artist:
        ...
        :returns: an :class:`~deezer_python.Artist` object
        """
    ...
    def get_chart(self, genre_id: int = 0) -> Chart:
        ...
        :returns: a :class:`~deezer_python.Chart` instance.
        """
        return self.request(
    ...
    def get_tracks_chart(self, genre_id: int = 0) -> list[Track]:
        ...
        :param genre_id: the genre ID, default to `All` genre (genre_id = 0).
        :return: a list of :class:`~deezer_python.Track` instances.
        """
    ...
    def get_albums_chart(self, genre_id: int = 0) -> list[Album]:
        ...
        :param genre_id: the genre ID, default to `All` genre (genre_id = 0).
        :return: a list of :class:`~deezer_python.Album` instances.
        """
    ...
    def get_artists_chart(self, genre_id: int = 0) -> list[Artist]:
        ...
        :param genre_id: the genre ID, default to `All` genre (genre_id = 0).
        :return: a list of :class:`~deezer_python.Artist` instances.
        """
    ...
    def get_playlists_chart(self, genre_id: int = 0) -> list[Playlist]:
        ...
        :param genre_id: the genre ID, default to `All` genre (genre_id = 0).
        :return: a list of :class:`~deezer_python.Playlist` instances.
        """
    ...
    def get_podcasts_chart(self, genre_id: int = 0) -> list[Podcast]:
        ...
        :param genre_id: the genre ID, default to `All` genre (genre_id = 0).
        :return: a list of :class:`~deezer_python.Podcast` instances.
        """
    ...
    def get_editorial(self, editorial_id: int) -> Editorial:
        ...
        :returns: a :class:`~deezer_python.Editorial` object.
        """
    ...
    def list_editorials(self) -> PaginatedList[Editorial]:
        ...
        :returns: a :class:`~deezer_python.pagination.PaginatedList`
                  of :class:`~deezer_python.Editorial` objects.
        """
    ...
    def get_episode(self, episode_id: int) -> Episode:
        ...
        :returns: a :class:`~deezer_python.Episode` object
        """
    ...
    def get_genre(self, genre_id: int) -> Genre:
        ...
        :returns: a :class:`~deezer_python.Genre` object
        """
    ...
    def list_genres(self) -> list[Genre]:
        ...
        :return: a list of :class:`~deezer_python.Genre` instances
        """
    ...
    def get_playlist(self, playlist_id: int) -> Playlist:
        ...
        :returns: a :class:`~deezer_python.Playlist` object
        """
    ...
    def get_podcast(self, podcast_id: int) -> Podcast:
        ...
        :returns: a :class:`~deezer_python.Podcast` object
        """
    ...
    def get_radio(self, radio_id: int) -> Radio:
        ...
        :returns: a :class:`~deezer_python.Radio` object
        """
    ...
    def list_radios(self) -> list[Radio]:
        ...
        :return: a list of :class:`~deezer_python.Radio` instances
        """
    ...
    def get_radios_top(self) -> PaginatedList[Radio]:
        ...
        :returns: a :class:`~deezer_python.pagination.PaginatedList`
                  of :class:`~deezer_python.Radio` objects.
        """
    ...
    def get_track(self, track_id: int) -> Track:
        ...
        :returns: a :class:`~deezer_python.Track` object
        """
    ...
    def get_user(self, user_id: int | None = None) -> User:
        ...
        :returns: a :class:`~deezer_python.User` object
        """
    ...
    def get_user_albums(self, user_id: int | None = None) -> PaginatedList[Album]:
        ...
        :returns: a :class:`~deezer_python.pagination.PaginatedList`
                  of :class:`~deezer_python.Album` objects.
        """
        user_id_str = str(user_id) if user_id else "me"
    ...
    def get_user_artists(self, user_id: int | None = None) -> PaginatedList[Artist]:
        ...
        :return: a :class:`~deezer_python.pagination.PaginatedList`
                 of :class:`~deezer_python.Artist` instances.
        """
        user_id_str = str(user_id) if user_id else "me"
    ...
    def get_user_followers(self, user_id: int | None = None) -> PaginatedList[User]:
        ...
        :returns: a :class:`~deezer_python.pagination.PaginatedList`
                 of :class:`~deezer_python.User` instances.
        """
        user_id_str = str(user_id) if user_id else "me"
    ...
    def get_user_history(self) -> PaginatedList[Track]:
        ...
        :return: a :class:`~deezer_python.pagination.PaginatedList`
                 of :class:`~deezer_python.Track` instances.
        """
    ...
    def search(
        ...
        :returns: a list of :class:`~deezer_python.Track` instances.
        """
        return self._search(
            "",
            query=query,
    ...
    def search_albums(
        ...
        :param strict: whether to disable fuzzy search and enable strict mode.
        :param ordering: see Deezer API docs for possible values.
        :return: list of :class:`~deezer_python.Album` instances.
        """
        return self._search(
            path="album",
            query=query,
